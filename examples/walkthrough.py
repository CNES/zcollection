"""End-to-end Phase 1 walkthrough for ``zcollection3``.
...
def build_dataset(schema: zc.DatasetSchema, n_partitions: int = 4,
...
if __name__ == "__main__":
    target = Path(sys.argv[1]) if len(sys.argv) > 1 else Path(tempfile.gettempdir()) / "zc3-walkthrough"
    main(target)
